  ...
  export default {
    ...
    data () {
      return {
        ...
        pics: [
          [
            'https://s.kcimg.cn/app/icon/oxman/qz-ico.png',
            'https://s.kcimg.cn/app/icon/oxman/qzx-ico.png'
          ],
          [
            'https://s.kcimg.cn/app/icon/oxman/wz-ico.png',
            'https://s.kcimg.cn/app/icon/oxman/wzx-ico.png'
          ]
        ]
      }
    },
